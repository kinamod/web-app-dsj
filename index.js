...
// 👉 Replace this with express-openid-connect require 👈 - REPLACED with line above
const axios = require("axios").default; //Added this line from A0FUN-M06-L01-WorkingWithAPIs
...
// 👉 Replace this with auth middleware 👈 - REPLACED with section below
app.use(
 auth({
   secret: SESSION_SECRET,
   auth0Logout: true,
   baseURL: APP_URL,
   authRequired: false, //👈 - added this
      // 👇 add this 👇
   authorizationParams: {
